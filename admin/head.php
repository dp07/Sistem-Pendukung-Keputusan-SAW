...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="index.php"><h6 style="font-weight: bold; color: white;">Sistem Pendukung Keputusan || Pemberian Bantuan Pada Masyarakat Kurang Mampu</h6></a>             
            </div>
            <div class="navbar-right" style="margin-top: 7px;">               
            <a class="navbar-brand" style="color: white; font-size: 12px; font-weight: bold;" href="logout.php"><i class="fa fa-sign-out"></i> Keluar</a>
            </div>            
        </div>
    </div>
